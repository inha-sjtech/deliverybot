...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=['0', '0', '0', '0', '0', '0', '1', 'livox_frame', 'cloud']
        ),
        Node(
            package='pointcloud_to_laserscan', executable='pointcloud_to_laserscan_node',
            remappings=[('cloud_in', [LaunchConfiguration(variable_name='scanner'), '/livox/lidar_192_168_1_113']),
                        ('scan', [LaunchConfiguration(variable_name='scanner'), '/publich_laser_scan'])],
            parameters=[{
                'target_frame': 'cloud',
